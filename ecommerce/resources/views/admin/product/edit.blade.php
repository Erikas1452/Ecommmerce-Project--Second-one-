                ...
                <form method="post" action="{{ url('update/product/withoutphoto/' . $product->id) }} "
                    ...
                    <div class="form-layout">
                        ...
                        <div class="row">
                            ...
                            <div class="col-lg-4">
                                <label class="ckbox">
                                    <input type="checkbox" name="main_slider" value="1" <?php
                            ...
                            <div class="col-lg-4">
                                <label class="ckbox">
                                    <input type="checkbox" name="hot_deal" value="1" <?php
                            ...
                            <div class="col-lg-4">
                                <label class="ckbox">
                                    <input type="checkbox" name="best_rated" value="1" <?php
                            ...
                            <div class="col-lg-4">
                                <label class="ckbox">
                                    <input type="checkbox" name="trend" value="1" <?php
                                    if ($product->trend == 1) {
                                            echo 'checked';
                                        }
                                        ?>
                            ...
                            <div class="col-lg-4">
                                <label class="ckbox">
                                    <input type="checkbox" name="mid_slider" value="1" <?php
                            ...
                            <div class="col-lg-4">
                                <label class="ckbox">
                                    <input type="checkbox" name="hot_new" value="1" <?php
